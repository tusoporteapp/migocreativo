/* MigoBot - Chatbot Wiki de Estampado Textil */
(function(){
const KB=[
...
{k:["formato","archivo","ai","psd","png","jpg","eps","vector","vectorizar"],r:"📁 FORMATOS DE ARCHIVO\n\n🖨️ Para Serigrafía:\n• Ideal: AI, EPS, SVG (vectores)\n• Aceptable: PSD con capas separadas por color\n• Resolución: 300 DPI mínimo\n\n🎯 Para DTF:\n• Ideal: PNG con fondo transparente\n• Aceptable: PSD, TIFF\n• NO usar: JPG (no soporta transparencia)\n\n✨ Para Sublimación:\n• Ideal: TIFF en CMYK\n• Aceptable: PSD, PNG\n• Debe estar en espejo y con perfil ICC\n\n⚠️ NUNCA uses imágenes de internet a 72 DPI. No sirven para estampar."},
{k:["separación","separacion","separar colores","fotolito","trama"],r:"🔬 SEPARACIÓN DE COLORES (Serigrafía)\n\nEs el proceso de dividir un diseño en sus colores individuales. Cada color se imprime por separado con su propia pantalla.\n\nTipos:\n• Directa/Spot: Cada color es una tinta Pantone. Para diseños de 1-6 colores planos.\n• Cuatricromía (CMYK): Se simula el color con 4 pantallas (C, M, Y, K). Para fotos.\n• Simulated Process: Se simulan colores con tintas spot. Para fotos en tela oscura.\n• Index Color: Se usa una cuadrícula de puntos. Menos pantallas que simulated.\n\nEn Migo Creativo hacemos la separación de colores profesional para tu diseño."},
{k:["temperatura","calor","prensa","plancha","tiempo","presión","presion","transfer"],r:"🌡️ TEMPERATURAS DE TRANSFERENCIA\n\n🎯 DTF:\n• Temperatura: 160-170°C\n• Tiempo: 15-20 segundos\n• Presión: Media-Alta\n• Pelado: Tibio o frío (según el polvo)\n\n✨ Sublimación:\n• Temperatura: 190-210°C\n• Tiempo: 45-60 segundos\n• Presión: Media\n• Papel: Papel de sublimación específico\n\n⚠️ Estas temperaturas son guías generales. Siempre haz pruebas con tu equipo específico antes de producir en cantidad."},
{k:["empezar","comenzar","negocio","emprendimiento","equipo","máquina","maquina","invertir","necesito"],r:"🚀 ¿QUIERES EMPEZAR EN ESTAMPADO?\n\nEquipo mínimo por técnica:\n\n🎯 DTF (más fácil para empezar):\n• Impresora DTF (desde $2M COP)\n• Horno de curado o pistola de calor\n• Prensa de calor\n• Film PET y polvo adhesivo\n\n✨ Sublimación:\n• Impresora con tinta de sublimación\n• Prensa de calor\n• Papel de sublimación\n• Prendas de poliéster\n\n🖨️ Serigrafía:\n• Mesa de estampado\n• Marcos y mallas\n• Insoladora\n• Rasero/Squeegee\n• Tintas\n\n💡 Consejo de Miguel: Si estás empezando, DTF es la forma más rápida y económica de arrancar."},
{k:["error","problema","sale mal","defecto","mancha","borroso","opaco","deslavado"],r:"🔧 PROBLEMAS COMUNES Y SOLUCIONES\n\n❌ Colores opacos/apagados:\n→ Verifica el perfil ICC y la calibración\n→ Revisa la calidad de la tinta\n\n❌ Imagen borrosa:\n→ Tu archivo tiene menos de 300 DPI\n→ La imagen fue descargada de internet\n\n❌ El estampado se pela:\n→ (DTF) Temperatura o tiempo incorrectos\n→ (DTF) Polvo adhesivo insuficiente\n\n❌ Colores diferentes a la pantalla:\n→ Tu monitor no está calibrado\n→ No estás usando perfil ICC\n\n❌ Líneas de trama visibles:\n→ (Serigrafía) La resolución del fotolito es baja\n→ Usa mínimo 300 DPI para el fotolito\n\n¿Necesitas ayuda profesional? 💬 wa.me/573023579755"},
{k:["gracias","thank","genial","excelente","perfecto","chévere","chevere"],r:"¡Con mucho gusto! 😊 Si necesitas optimizar tus imágenes para producción, recuerda que en Migo Creativo estamos para ayudarte. 💬 WhatsApp: wa.me/573023579755"},
{k:["taza","mug","carcasa","mouse pad","rígido","rigido","producto"],r:"🎁 ESTAMPADO EN PRODUCTOS RÍGIDOS\n\nPara tazas, mouse pads, carcasas y similares se usa SUBLIMACIÓN.\n\nRequisitos:\n• El producto debe tener recubrimiento de poliéster\n• Imagen en CMYK a 300 DPI\n• Imagen en espejo\n• Plantilla del producto (para ajustar el diseño al área imprimible)\n\n⚠️ DTF NO se recomienda para superficies rígidas.\n⚠️ Serigrafía tampoco funciona en estos productos (excepto serigrafía UV para algunos casos)."},
{k:["camiseta","camisa","polo","hoodie","gorra","textil"],r:"👕 ESTAMPADO EN PRENDAS\n\nPara camisetas/hoodies:\n• Algodón + pocos colores → Serigrafía\n• Algodón + full color → DTF\n• Poliéster + tela clara → Sublimación\n• Cualquier tela + pocas unidades → DTF\n\nPara gorras:\n• DTF es el más versátil\n• Sublimación solo si es poliéster blanco\n\nPara uniformes corporativos:\n• Serigrafía si son muchas unidades\n• DTF si son pocas unidades o el logo tiene muchos colores"}
];
const fallback="🤔 No tengo una respuesta específica para eso, pero puedo ayudarte con:\n\n• Serigrafía, DTF, Sublimación\n• Resolución y formatos de archivo\n• Perfiles de color (CMYK, RGB, Pantone)\n• Separación de colores\n• Temperaturas de transferencia\n• Tipos de tela\n• Durabilidad\n• Problemas comunes\n\nIntenta preguntarme sobre alguno de estos temas. O escríbele a Miguel directamente: 💬 wa.me/573023579755";
...
function createBot(){
  ...
  <div class="mcbot-header">
    <img src="assets/img/LOGO/LOGO NUEVO.jpg" alt="MigoBot">
  ...
  const quickBtns=["¿Qué es DTF?","Serigrafía","Sublimación","Diferencias","Formatos","Durabilidad","Temperaturas"];
